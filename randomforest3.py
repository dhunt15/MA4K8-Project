...
#df_test = df_entire.iloc[3675:4040]
...
plt.plot(df_val['date'], df_val['close_original']/df_val['close_original'][0] * 500 + 500, 
    label = "50/50 strategy", lw = 2, color = "orange")
...
for c in c_list:
    ...
    results_tc.append({"c": c,"Risk": R_hat, "OracleRisk": R_or, "Regret": regret})
...
ann_vol = log_rets.std() * np.sqrt(365.25)
